...
public class NumericManufacturer {
	 ...
	 */
	public static final boolean isNumeric ( String searchSentence ) {
	...
	/**
	 * 
	 * 입력받은 문자열을 숫자로 시작하는 문자열로 변경해서 반환해주는 매서드
	 * 
	 * @param searchSentence 입력받은 문자열
	 * @return 숫자로 시작하는 searchSentence의 substring, 숫자가 없을 시 null을 반환
	 */
	public static final String getSubstringStartingWithNumeric( String searchSentence ) {
		...
		try{
			...
			return searchSentence.substring( startPosition );
